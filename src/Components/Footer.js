...
export default () => (
  <div className="sticky-footer d-flex align-items-center p-1">
    ...
    <a href="https://www.linkedin.com/in/amking23/" target="_blank">
      <div className="footer-icon">
        <Linkedin />
      </div>
    </a>
    <a href="https://github.com/amking23" target="_blank">
      <div className="footer-icon">
        <Github />
      </div>
    </a>
    <a href="mailto:amking23@gmail.com" target="_blank">
      <div className="footer-icon">
        <Email />
      </div>
    </a>
    <a href="https://www.facebook.com/riebieee/" target="_blank">
      <div className="footer-icon">
        <Facebook />
      </div>
    </a>
    <a href="https://www.instagram.com/aamk23/" target="_blank">
      <div className="footer-icon">
        <Instagram />
      </div>
    </a>
